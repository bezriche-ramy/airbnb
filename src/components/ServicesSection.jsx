  ...
  const services = [
    {
      ...
      features: [
        ...
        'Optimisation des tarifs et du calendrier',
        'Sélection rigoureuse des locataires',
        'Reporting mensuel clair et précis'
      ]
    },
    {
      id: 2,
      ...
      features: [
        ...
        'Maintenance technique et suivi régulier',
        'Linge de maison et produits d\'accueil premium'
      ]
    },
    {
      id: 3,
      title: 'Accueil et expérience client',
      ...
      features: [
        'Check-in/check-out personnalisés',
        'Disponibilité 7j/7 pendant le séjour',
        'Recommandations locales et services à la carte'
      ]
    },
    {
      id: 4,
      ...
      date: 'Service Premium',
      features: [
        'Conseils en aménagement et mise en scène',
        'Photographie professionnelle',
        'Accompagnement pour maximiser le potentiel de votre propriété'
      ]
    }
  ];
      ...
      <div className="services-container">
        ...
        <div className="services-header">
          <h2 className="services-main-title">
            Une gestion complète, pensée pour les propriétaires exigeants.
          </h2>
          <p className="services-intro">
            Avec B&C Conciergerie Côte d'Azur, la location saisonnière devient simple, fluide et rentable.
            Nous prenons en charge toutes les étapes de gestion, pour que votre bien soit toujours impeccable, 
            vos voyageurs satisfaits et vos revenus optimisés.
          </p>
        </div>
